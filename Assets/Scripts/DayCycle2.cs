...
/// </remarks>
public class DayCycle2 : MonoBehaviour
{
    /// <summary>
    ...
    public void SetDawn()
    {
        ...
        RenderSettings.skybox.SetColor("_TopColor", skyColorDawnDusk);
    ...
    {
        RenderSettings.skybox.SetColor("_TopColor", skyColorNight);
